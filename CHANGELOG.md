...
- 主站作品库归为三项：Janet 专属作品集、影像参考实验室、错位名场面系列剧集。旧分类链接兼容映射到新总集。
- 专属作品集增加《标准答案 / LA RESPUESTA》与 QUIET HEAT，两部成片及制作图、角色、场景、封面、剧本按项目归档。
- 《标准答案》提供 1080p 网页完成篇、43 张制作图、12 张成片截帧、5 张封面与可展开剧本；制作图可筛选。
- QUIET HEAT 提供 720p / 1080p 切换，保留 4 张角色、8 张场景、48 张画面和 31 张参考图；图库支持键盘操作与放大查看。
- 镜场计划增加侧栏独立折叠入口与《老男孩》更新，修复移动端嵌套网格把横幅挤为竖条的问题，并保留实验室与提示词手册双入口。
- 卡片悬停只更新活动卡片，按帧间隔计算缓动；光标停止移动后停止刷新，地球离屏或页面进入后台时取消动画帧。
- 防止动态内容刷新重复包装标题与绑定入场观察；减少动作偏好下停止地球自动旋转，锚点改用即时滚动。
- 更新站点地图、资源版本号与快捷图标归档。
