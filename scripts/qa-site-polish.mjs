...
function main() {
  ...
  for (const file of HTML_FILES) {
    ...
    const checks = [
      ...
      ['og:image', /<meta\s+property=["']og:image["']\s+content=["']https:\/\/yaojingwen2002\.github\.io\/janet-public-site\/assets\/og\/[^"']+\.(?:png|svg)["']/i],
  ...
  const result = {
    ...
    og_assets_exist: ['assets/og/janet-og.png', 'assets/og/news-og.png', 'assets/og/works-og.png'].every((file) => existsSync(resolve(ROOT, file))),
